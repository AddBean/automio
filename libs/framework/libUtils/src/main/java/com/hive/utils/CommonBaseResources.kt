...
class CommonBaseResources(val resources: Resources) :
    Resources(resources.assets, resources.displayMetrics, resources.configuration) {
    override fun getString(id: Int): String {
        return GlobalApp.getString(id)
    }

    override fun getString(id: Int, vararg formatArgs: Any?): String {
        return GlobalApp.getString(id, *formatArgs)
    }

    override fun getText(id: Int): CharSequence {
        return GlobalApp.getText(id)
    }

    override fun getTextArray(id: Int): Array<CharSequence> {
        return GlobalApp.getTextArray(id)
    }

    override fun getStringArray(id: Int): Array<String?> {
        return GlobalApp.getStringArray(id)
    }

    override fun getIntArray(id: Int): IntArray {
        return GlobalApp.getIntArray(id)
    }
    ...
    override fun getDimension(id: Int): Float {
        return GlobalApp.getDimension(id)
    }
    ...
    override fun getDrawable(id: Int): Drawable? {
        return GlobalApp.getDrawable(id)
    }
    ...
    override fun getInteger(id: Int): Int {
        return GlobalApp.getInteger(id)
    }
    ...
    override fun updateConfiguration(config: Configuration?, metrics: DisplayMetrics?) {
        val thisResources: Resources? = resources
        thisResources?.updateConfiguration(config, metrics)
    }
