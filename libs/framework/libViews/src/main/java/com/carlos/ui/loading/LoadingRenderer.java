...
public abstract class LoadingRenderer {
    ...
    private static final float DEFAULT_SIZE = 112.0f;
    ...
    boolean isStarted(){
        return mRenderAnimator.isStarted();
    }
    ...
    private void initParams(Context context) {
        mWidth =  ConvertUtils.dp2px(DEFAULT_SIZE);
        mHeight = ConvertUtils.dp2px(DEFAULT_SIZE);
