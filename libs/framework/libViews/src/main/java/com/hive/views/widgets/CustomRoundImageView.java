...
public class CustomRoundImageView extends androidx.appcompat.widget.AppCompatImageView {
     ...
     */
    private int mWidth;
    private RectF mRoundRect = new RectF(0, 0, 1, 1);
...
//        Log.e("TAG", "onMeasure");
    ...
    private Bitmap drawableToBitamp(Drawable drawable) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(w > 0 ? w : 1, h > 0 ? h : 1, Bitmap.Config.ARGB_8888);
    ...
    protected void onDraw(Canvas canvas) {
        if (getDrawable() == null || mRoundRect == null) {
            return;
        }
        setUpShader();
        if (type == TYPE_ROUND) {
