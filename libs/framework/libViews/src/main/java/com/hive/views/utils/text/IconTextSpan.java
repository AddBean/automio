...
package com.hive.views.utils.text;
...
public class IconTextSpan extends ReplacementSpan {
    ...
    private void initPaint() {
        //初始化背景画笔
        mBgPaint = new Paint();
        mBgPaint.setColor(GlobalApp.getColor(mBgColorResId));
        mBgPaint.setStyle(Paint.Style.FILL);
        mBgPaint.setAntiAlias(true);

        //初始化文字画笔
        mTextPaint = new TextPaint();
        mTextPaint.setColor(GlobalApp.getColor(mTextColorResId));
    ...
    private void initDefaultValue(Context context, int bgColorResId, String text) {
        ...
        this.mTextColorResId = com.hive.i8n.R.color.white;
    }
    ...
    public void draw(@NonNull Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, Paint paint) {
        ...
        bgPaint.setColor(GlobalApp.getColor(mBgColorResId));
        ...
        textPaint.setColor(GlobalApp.getColor(mTextColorResId));
