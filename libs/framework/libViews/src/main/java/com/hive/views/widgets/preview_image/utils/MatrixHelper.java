...
public class MatrixHelper {
    ...
    public MatrixHelper(float[] values) {
        this();
        setValues(values);
    }
    ...
    public MatrixHelper copy() {
        return new MatrixHelper(getValues());
    }

    public void multiply(MatrixHelper m) {
    ...
    /**求逆矩阵**/
    public MatrixHelper inverseMatrix() {
