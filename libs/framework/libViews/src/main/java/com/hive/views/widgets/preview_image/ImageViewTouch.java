...
package com.hive.views.widgets.preview_image;
...
import com.hive.views.widgets.preview_image.utils.BitmapHelper;
...
public class ImageViewTouch extends ImageViewTouchBase {
    ...
    protected void onDrawableChanged(Drawable drawable) {
        ...
        if (mOnImageLoadListener != null)
            mOnImageLoadListener.onDrawableLoaded(drawable);
    }

    public void flip(boolean isVer) {
        mBitmap = BitmapHelper.flip(mBitmap, false);
        setImageBitmap(mBitmap);
    }

    public void rotate(float degree) {
        mBitmap = BitmapHelper.rotate(mBitmap,degree);
        setImageBitmap(mBitmap);
    }

    private OnImageLoadListener mOnImageLoadListener;

    public void setOnImageLoadListener(OnImageLoadListener mOnImageLoadListener) {
