...
public class TDialog extends BaseTDialogFragment implements DialogInterface {
    ...
    protected boolean shallInterceptBackPressKey() {
        return tController.shallInterceptBackPressEvent();
    }
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder interceptBackpressEvent(boolean isIntercepted) {
            params.shallInterceptBackPressEvent = isIntercepted;
            return this;
        }
