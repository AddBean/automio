...
import com.hive.views.widgets.dialog.listener.OnBindViewListener;
...
public class TController<A extends TBaseAdapter> implements Parcelable, Serializable {
    ...
    private boolean shallInterceptBackPressEvent;
    ...
    protected TController(Parcel in) {
        ...
        shallInterceptBackPressEvent = in.readByte() != 0;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (shallInterceptBackPressEvent ? 1 : 0));
    }
    ...
    public boolean shallInterceptBackPressEvent() {
        return shallInterceptBackPressEvent;
    }
    ...
    public static class TParams<A extends TBaseAdapter> {
        ...
        public void apply(TController tController) {
            ...
            tController.shallInterceptBackPressEvent = shallInterceptBackPressEvent;
            ...
            if (adapter != null) {
                ...
                if (tController.getLayoutRes() <= 0 && tController.getDialogView() == null) {
                    throw new IllegalArgumentException(com.hive.utils.GlobalApp.getString(com.hive.i8n.R.string.views_set_layout_res_required));
                }
            }
