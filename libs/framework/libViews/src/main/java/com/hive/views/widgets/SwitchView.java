...
public class SwitchView extends View {
    ...
    private OnStateChangedListener mDefaultListener = new OnStateChangedListener() {
        @Override
    ...
    private OnStateClickListener mDefaultClickListener;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSize = (int) (widthSize * 0.63f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? Color.parseColor("#FD415F") : 0xffe3e3e3);
        ...
        paint.setColor(isOn ? /*Color.parseColor("#FD415F")*/0xffbfbfbf : 0xffbfbfbf);
        canvas.drawPath(bPath, paint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if ((state == STATE_SWITCH_ON || state == STATE_SWITCH_OFF) && (0 == Float.compare(sAnim * bAnim, 0.0f))) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(mDefaultClickListener != null && mDefaultClickListener.onClick(this)){
                        return super.onTouchEvent(event);
                    }
                    if (state == STATE_SWITCH_OFF2) {
                        mDefaultListener.toggleToOn(this);
                    } else if (state == STATE_SWITCH_ON2) {
                        mDefaultListener.toggleToOff(this);
                    }
                    break;
            }
        }
    ...
    public void setOnStateChangedListener(OnStateChangedListener listener) {
        if (listener == null) throw new IllegalArgumentException("empty mDefaultListener");
        this.mDefaultListener = listener;
    }

    public void setOnStateClickListener(OnStateClickListener listener){
        if (listener == null) throw new IllegalArgumentException("empty mDefaultListener");
        this.mDefaultClickListener = listener;
    }
    ...
    /**
     * @param newState {@link #STATE_SWITCH_ON},{@link #STATE_SWITCH_OFF}
     */
    ...
    public Parcelable onSaveInstanceState() {
        ...
        bundle.putBoolean("openState", this.isOpened);
        return bundle;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state != null && state instanceof Bundle) {
            ...
            this.isOpened = bundle.getBoolean("openState");
