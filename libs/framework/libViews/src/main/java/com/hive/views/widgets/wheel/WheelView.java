...
import com.hive.views.widgets.wheel.adapters.WheelViewAdapter;
...
//			0x00AAAAAA, 0x00AAAAAA };
    ...
    public boolean drawCenterRect = true;
    ...
    public void setShadowColor(int[] colors) {
        SHADOWS_COLORS =colors;
    }
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(GlobalApp.getColor(com.hive.i8n.R.color.province_line_border));
        // 设置线宽
