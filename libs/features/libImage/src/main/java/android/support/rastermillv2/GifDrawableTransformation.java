 ...
 * {@link FrameSequenceDrawable}.
 */
public class GifDrawableTransformation implements Transformation<FrameSequenceDrawable> {
    ...
    public Resource<FrameSequenceDrawable> transform(
            @NonNull Context context, @NonNull Resource<FrameSequenceDrawable> resource,
