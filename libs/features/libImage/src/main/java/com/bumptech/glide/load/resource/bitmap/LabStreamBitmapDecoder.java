 ...
 */
public class LabStreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {

  private final LabDownSampler downsampler;
  private final ArrayPool byteArrayPool;

  public LabStreamBitmapDecoder(LabDownSampler downsampler, ArrayPool byteArrayPool) {
   ...
   */
  public static class UntrustedCallbacks implements LabDownSampler.DecodeCallbacks {
