 ...
 * @author liuchun
 */
public class LabByteBufferBitmapWebpStaiticDecoder implements ResourceDecoder<ByteBuffer, Bitmap> {
    private final LabWebpStaticDownsampler downsampler;

    public LabByteBufferBitmapWebpStaiticDecoder(LabWebpStaticDownsampler downsampler) {
