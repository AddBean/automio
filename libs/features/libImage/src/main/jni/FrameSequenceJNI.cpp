...
#define JNI_PACKAGE "android/support/rastermillv2"
...
jint FrameSequence_OnLoad(JNIEnv* env) {
    ...
    gFrameSequenceClassInfo.ctor = env->GetMethodID(gFrameSequenceClassInfo.clazz, "<init>", "(JIIZIII)V");
