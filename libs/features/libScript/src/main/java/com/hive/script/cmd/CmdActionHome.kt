 ...
 * @date 6/8/21
 */
@AutoCmdRegister(type = IDS.CmdActionHome, name = "actionHome")
class CmdActionHome : ScriptCommand(), ScriptRegularInterface {
    ...
    override fun getCommandName() = GlobalApp.getString(com.hive.i8n.R.string.cmd_name_action_home)

    override fun getCommandDescribe() = GlobalApp.getString(com.hive.i8n.R.string.cmd_des_action_home)

    override fun getCommandIcon() = R.drawable.ic_menu_home

    override fun parseCmd(cmd: String) {
    }

    companion object {
        fun createCommand() = CmdActionHome()
    }
}