...
RE.setText = function(contents) {
    RE.editor.innerText = decodeURIComponent(contents.replace(/\+/g, '%20'));
}
...
RE.insertImage = function(url, alt) {
    var html = '<img  style="width:100%" src="' + url + '" alt="' + alt + '" /><p align=center style="color:#aaaaa;font-size:14px" >图片发自-</p><hr align=center width=200 color=#aaaaaa size=1 /><br/><br/>';
    RE.insertHTML(html);
}
